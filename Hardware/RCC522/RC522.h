...
extern uint8_t Card_Type1[2];  
extern uint8_t Card_ID[4]; 
extern uint8_t Card_KEY[6] ;   //{0x11,0x11,0x11,0x11,0x11,0x11};   //密码
extern uint8_t Card_Data[16];
extern uint8_t status;
extern uint16_t cardType;

#define RC522_RESET_PIN                GPIO_Pin_4     //res          
...
#define RC522_ENABLE 		GPIO_ResetBits(GPIOB,GPIO_Pin_12) //NSS
#define RC522_DISABLE 	GPIO_SetBits(GPIOB,GPIO_Pin_12)
